...
# Explicação:
# range(1, 51) gera números de 1 até 50.

# if numero % 2 == 0 verifica se o número é par.

# soma += numero acumula os pares na variável soma.
...
# Adapitando o meso execício para soma do números impares:
...
# # A saída será: A soma dos números ímpares de 1 a 50 é

# Explicação Detalhada:

# python
# soma = 0
# Cria a variável soma com valor inicial 0.

# Usamos ela para guardar a soma acumulada dos números ímpares.

# for numero in range(1, 51):
# Cria um laço que vai do número 1 até 50, incluindo o 1 e o 50.

# numero vai assumindo esses valores um por um.


# if numero % 2 != 0:
# O operador % (módulo) retorna o resto da divisão.

# Se numero % 2 != 0, significa que o número não é divisível por 2, ou seja, é ímpar.


#     soma += numero
# Adiciona o número ímpar à variável soma.
...
# A soma dos números ímpares de 1 a 50 é: 625
...
# for letra in palavra.lower():  # Converte para minúsculas para comparar corretamente
#     if letra in vogais:
#         contador += 1

# # Mostra o resultado
# print("A palavra contém", contador, "vogais.")
...
#     Explicação linha por linha:
# soma = 0
# Cria uma variável para acumular as notas.

# for i in range(1, 6):
# Laço que se repete de 1 a 5 (inclusive).

# i é usado para indicar qual nota está sendo pedida.

# nota = float(input(...))
# Solicita a nota e converte para número decimal (float), pois pode ser como 7.5, 8.3 etc.

# soma += nota
# Soma a nota digitada ao total acumulado.
...
#  Exemplo de saída:
# Se o aluno digitar as notas: 7, 5, 8, 6, 4
